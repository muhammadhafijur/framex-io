        ...
        <div>
            <div className="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
                <div className="bg-white h-full rounded-2xl dark:bg-gray-700">
                    <NavLink
                        to="/"
                        className="flex items-center font-bold text-2xl justify-center pt-6"
                    >
                        Framex
                    </NavLink>
                    <nav className="mt-6">
...
=======
  return (
    <div>
      <div className="h-screen lg:block my-4 ml-4 shadow-lg relative w-80">
        <div className="bg-white h-full rounded-2xl dark:bg-gray-700">
          <NavLink
            to="/"
            className="flex items-center font-bold text-2xl justify-center pt-6"
          ...
          <nav className="mt-6">
            <div>
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Add Services</span>
              </Link>
              <Link
                to="/my-orders"
                className="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500"
...
>>>>>>> d3cfd100b6bae0f713f0d7da3068022709d749c7
            </div>
        </div>
    );
};
