        ...
        <div className="flex justify-between flex-wrap mt-20">
          <div className="flex flex-col items-center justify-center  p-3">
            <img
              ...
              src="https://image.freepik.com/free-photo/bride-putting-ring-her-husband_1157-545.jpg"
              alt=""
            />

            <h4 className="text-2xl my-5">Price: $566</h4>
            <h4 className="text-justify mb-5 w-3/5">
              Description: Lorem ipsum dolor sit amet consectetur adipisicing
              elit. Necessitatibus ab repellat quam minus nemo voluptates quos
              ad magnam dolores aspernatur consectetur quae nisi quibusdam
              voluptate velit iure impedit, doloremque magni delectus,
              perspiciatis excepturi nobis. Consequuntur possimus alias ut
              maxime magnam! Lorem, ipsum dolor sit amet consectetur adipisicing
              elit. Corrupti, ipsam!
            </h4>
